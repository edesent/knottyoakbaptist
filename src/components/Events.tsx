...
const FLYER_ONLY = ["Vacation Bible School", "Lake Compounce Trip"];
                ...
                return (
                  <div key={ev.title} className="flex flex-col rounded-sm border border-ink-faint/15 overflow-hidden hover:border-forest-600/40 hover:shadow-lg transition-all">
                    ...
                    <div className="bg-white px-4 py-4 flex flex-col items-center gap-3">
                      <img src="/2035.png" alt="Scan to register" className="w-32 h-32" />
                      <p className="text-xs text-ink-muted text-center">Scan to register or tap below</p>
                      <a href="/vbs-registration" className="block w-full text-center bg-forest-900 hover:bg-forest-700 text-white text-xs font-semibold tracking-wide uppercase py-3 px-3 rounded-sm transition-colors">
                        Register Online →
                      </a>
                    </div>
                  </div>

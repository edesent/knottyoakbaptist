...
const ministries = [
  ...
  },
  {
    ...
    age: "Grades 7 to 12",
    blurb:
      "The teenage years are preparation for adulthood, a season for spiritual growth and leadership. VBS leadership, teen camp, and year-round fellowship activities build deep, lasting friendships.",

        ...
        <div className="grid lg:grid-cols-12 gap-14 lg:gap-20 items-center">
          ...
          <div className="lg:col-span-7">
            ...
            <div className="mt-8 space-y-5 text-lg text-ink-body leading-relaxed max-w-2xl">
              ...
              <p>
                That teenager was me. I was born and raised in Coventry — I love this town. But for all its familiarity, I had no direction, no church background, and no idea what I was missing. Then one day I was invited to a teen game night by a childhood friend that attended Knotty Oak Baptist Church. I showed up with nothing but curiosity. What I found was warmth,
